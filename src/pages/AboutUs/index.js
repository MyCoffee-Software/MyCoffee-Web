...
import { Container, BannerContainer, LeftTextBlockContainer, RightTextBlockContainer, BannerImage, TextsContainer } from './styles';
  ...
  return (
    <section>
      <Container>
        ...
        <TextsContainer>
          <LeftTextBlockContainer>
            <TextBlock>
              {textContent1}
            </TextBlock>
          </LeftTextBlockContainer>
          <RightTextBlockContainer>
          <TextBlock>
              {textContent2}
            </TextBlock>
          </RightTextBlockContainer>  
